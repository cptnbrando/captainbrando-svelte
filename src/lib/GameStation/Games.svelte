<script>
    ...
    // https://storage.bunnycdn.com/captaingames//lsd.bin

    // gameurl - google drive link but it expires mad quick... i dont wanna use the google api its so annoyingly complicated... ugh
