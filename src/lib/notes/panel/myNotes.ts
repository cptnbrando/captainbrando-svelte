...
<br />
For 2 years I worked through cogs, a contracting company, for *@&**&#^ MoneyBankThing🤑💰🤑, I had a 3 month contract, then another 3 month contract, then a 6 month contract, then another 6, then another 6. *$^&&*#$$ paid every contract, because my code was one of the only things somehow not making things load with the massive fucking data moving through it.<br />
<br />
...
<br />
I got an offer at another company for double what I was making at &&$%# / [mechanical cog company] today. With a 10 thousand dollar signing bonus to boot, in cold hard cash (at least, thats the offer. gonna keep prepping for interviews after i finish typing this sentence. promise.).<br />
<br />
